...
<section class="tenant-detail-hero">
    <div class="tenant-identity">
        <span class="tenant-avatar"><i class="fa-solid fa-building-columns" aria-hidden="true"></i></span>
        <div>
            <span class="eyebrow">Tenant profile</span>
    ...
    <div class="tenant-hero-actions">
        ...
        <a class="button secondary" href="<c:url value='/web/tenants'/>"><i class="fa-solid fa-arrow-left" aria-hidden="true"></i>Back</a>
        <a class="button primary" href="<c:url value='/web/tenants/${tenant.id}/edit'/>"><i class="fa-solid fa-pen-to-square" aria-hidden="true"></i>Edit</a>
    </div>
</section>
...
<section class="tenant-info-panel tenant-audit-panel">
    <div class="tenant-section-heading">
        ...
        <div>
            ...
            <p>Recent updates recorded for this tenant</p>
        </div>
    </div>
    <div class="table-wrap">
        <table class="data-table tenant-log-table">
            ...
            <c:if test="${empty changeLogs}">
                <tr>
                    <td class="empty-cell" colspan="7">No entity change logs found for this tenant.</td>
                </tr>
            </c:if>
            </tbody>
        </table>
